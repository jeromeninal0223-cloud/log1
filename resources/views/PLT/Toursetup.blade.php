  ...
  <div class="page-header-container mb-4">
    <div class="d-flex justify-content-between align-items-center page-header">
      <div class="d-flex align-items-center">
        ...
        <div>
          <h2 class="fw-bold mb-1">Tour Setup</h2>
          <p class="text-muted mb-0">Welcome back, Sarah! Manage tour planning and logistics setup.</p>
        </div>
      </div>
          ...
          <ol class="breadcrumb mb-0">
            ...
            <li class="breadcrumb-item active" aria-current="page">Tour Setup</li>
          </ol>
        </nav>
    </div>
  </div>
