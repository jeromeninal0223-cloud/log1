...
<head>
  ...
  <title>Reset Password - JetLouge Travels</title>
  ...
  <div class="login-container">
    <div class="row g-0">
      ...
      <div class="col-lg-6 login-right">
        ...
        <form method="POST" action="{{ route('vendor.reset-password.submit') }}" id="resetForm">
          @csrf
          ...
          <button type="submit" class="btn btn-login mb-3" id="resetBtn">
  ...
  <script>
    document.addEventListener('DOMContentLoaded', function() {
      ...
      resetForm.addEventListener('submit', function(e) {
        ...
        // Show loading state
        submitBtn.innerHTML = '<i class="bi bi-arrow-clockwise me-2"></i>Resetting Password...';
